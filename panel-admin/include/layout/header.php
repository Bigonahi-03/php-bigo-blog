...
<head>
    ...
    <link
        ...
        <!-- Get CSS files for multiple locations -->
...
<body>
    <header
        ...
        <button class="ms-2 nav-link px-3 text-white d-md-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebarMenu"> <i class="bi bi-justify-left fs-2"></i>
        </button>
    </header>